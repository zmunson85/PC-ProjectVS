...
const sportDrink = new Inventory('sportDrink', 175);
...
const brownSwagger = new Enemies('BrownSwagger', 80, 130);
const fudgeBrownies = new Enemies('FudgeBrownies', 110, 160);
const jellyDoughNuts = new Enemies('JellyDoughNuts', 150, 200);
const gummyBears = new Enemies('gummyBears', 220, 270);
const hotTamales = new Enemies('hotTamales', 270, 325);
...
function enemyEncounter() {
    if (enemies.length == 0) {
        console.log('You did it! You eliminated all the sweets....killing a total of ' + newPlayer.playerName + newPlayer.enemyKilled);
        ...
        console.log('*DANGER* Its ' + newEncounter.enemy + ' the only way to defeat them is to eat them!!! who needs a fork?');
...
function firstFight(newEncounter) {
    ...
    if (newPlayer.hp == 0) {
        console.log(playerName + ' has been killed by ' + newEncounter.enemy + '.... Try again, better luck next time!')
